    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Введите ник пользователя', max_length=150, unique=True, verbose_name='Никнейм')),
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('admin', 'admin')], default='user', max_length=50, verbose_name='Пользовательская роль')),
